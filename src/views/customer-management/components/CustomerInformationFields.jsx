...
const CustomerInformationFields = (props) => {
  ...
  return (
    <div>
        ...
        <div className='flex flex-col border-r border-gray-200 pr-[30px] mt-[20px] border-b mb-[20px] pb-[20px]'>
            {/* Customer Name and Primary Contact No. */}
            <div className='flex flex-row'>

                {/* Customer Name */}
                <div className='flex flex-col'>
                    <Label htmlFor="name" className="text-[17px] ml-[30px] mt-[10px]"> <span className='text-red-500 mr-1'>*</span> Customer Name </Label>
                ...
                {/* Primary Contact No. */}
                <div className='flex flex-col'>
                    <Label htmlFor="mobile" className="mt-[10px] ml-[30px] text-[17px]"><span className='text-red-500 mr-1'>*</span> Primary Contact No.</Label>
            ...
            <div className='flex flex-row'>
                ...
                <div className='flex flex-col'>
                   <Label
                   htmlFor="email"
                   className="text-[17px] ml-[30px] mt-[20px]"> <span className='text-red-500 mr-1'>*</span> Primary Email</Label>
                ...
                <div className='flex flex-col'>
                   ...
                   > <span className='text-red-500 mr-1'>*</span> Payment Terms (in Days)</Label>
                   ...
                   onChange={(e) => setFieldValue("payment_term", Number(e.target.value))}
            ...
            <div className='flex flex-row'>
                {/* Relationship manager */}
                   <div className='flex flex-col'>
                        ...
                        className="text-[17px] ml-[30px] mt-[20px]"> <span className='text-red-500 mr-1'>*</span>
                            Relationship Manager
                        </Label>

                        <Select
                        onValueChange={(value)=> setFieldValue("relationship_manager",value)}
