// frontend/src/views/customer-management/components/Location.jsx
import React from "react";
import { useDispatch, useSelector } from "react-redux";
import { setMapOpen, confirmPosition, cancelPosition } from "../../../features/customerManagement/leafletLocationSlice";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { Button } from "@/components/ui/button";
import LeafletMapDialog from "./LeafletMapDialog";

export default function LeafLetLocation(props) {
  ...
  return (
    <div>
        ...
        <div className="flex items-center mb-4">
          ...
          <div style={{ flex: 1 }} onClick={openMap}>
            <Input
              ...
              value={address || values.billing_google_address || ""}
              readOnly
          ...
          <div className="ml-3">
            <Button onClick={openMap} className="bg-green-400 text-black">
              Select
            </Button>
          </div>
        </div>
      ...
      {/* Map Dialog - pass Formik setter via onConfirm */}
      <LeafletMapDialog
        isOpen={mapOpen}
