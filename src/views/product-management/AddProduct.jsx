...
const AddProduct = () => {
  ...
  const { categories, usageUnits ,loading, successMessage, error } =
    useSelector((state) => state.product);

  const [imagePreview, setImagePreview] = useState(null);

  //fetch categories and usage units on mount
  useEffect(() => {
  ...
  return (
    <div>
      <div className="w-full h-full bg-[#eaeaea] pb-[20px] pt-[20px] border border-white rounded-2xl">
        <span className="text-2xl font-semibold ml-[20px]">Add Product</span>
                    ...
                    <div className="flex flex-row">
                      ...
                      <div className="flex flex-col ">
                        ...
                        {touched.image && errors.image && (
                          <p className="text-red-500 text-sm mt-1 ml-[150px]">
                            {errors.image}
                          </p>
                        )}
                      </div>
